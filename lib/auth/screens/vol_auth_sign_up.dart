...
class VolAuthSignUp extends ConsumerWidget {
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    "Sign up to VolunteersConnect.com with google",
                    style: TextStyle(
                        color: HexColor("#1d4980"),
                        fontSize: 18,
                        letterSpacing: -0.3),
                        ...
                        CustomInputTextField(
                          ...
                          validate: (value) {
                            if (value == null || value.isEmpty) {
                              ...
                              return "please enter the username of length greater than 8";
                            } else if (value.contains(' ')) {
                              return "please remove whitespaces from username";
                            }
                            return null;
                          },
                        ),
